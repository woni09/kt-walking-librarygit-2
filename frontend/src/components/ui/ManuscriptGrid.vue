            ...
            <div class="table-responsive">
                <v-table>
                    <thead>
                        ...
                        <th>Content</th>
                        <th>Status</th>
                        <th>ImageRequested</th>
                        <th>AiSummaryRequested</th>
                        <th>Category</th>
                        <th>ImagePath</th>
                        <th>Summary</th>
                        <th>Price</th>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap" label="ImageRequested">{{ val.imageRequested }}</td>
                            <td class="whitespace-nowrap" label="AiSummaryRequested">{{ val.aiSummaryRequested }}</td>
                ...
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            ...
                            <Boolean label="ImageRequested" v-model="selectedRow.imageRequested" :editMode="true"/>
                            <Boolean label="AiSummaryRequested" v-model="selectedRow.aiSummaryRequested" :editMode="true"/>
                            ...
                            <New Enumeration offline label="Status" v-model="selectedRow.status" :editMode="true"/>
