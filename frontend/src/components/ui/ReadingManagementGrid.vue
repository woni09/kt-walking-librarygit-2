                ...
                <v-table>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap" label="CurrentPage">{{ val.currentPage }}</td>
                            <td class="whitespace-nowrap" label="ReadingStatus">{{ val.readingStatus }}</td>
            ...
            >
                <v-card>
                    <v-toolbar
                        ...
                        height="50px"
                    >
                        <div style="color:white; font-size:17px; font-weight:700;">ReadingManagement 등록</div>
                        <v-spacer></v-spacer>
                        <v-icon
                            color="white"
                            small
                    ...
                    <v-card-text>
                        <ReadingManagement :offline="offline"
                            :isNew="!value.idx"
                            :editMode="true"
                            :inList="false"
                            v-model="newValue"
            ...
            >
                <v-card>
                    <v-toolbar
                        ...
                        height="50px"
                    >
                        <div style="color:white; font-size:17px; font-weight:700;">ReadingManagement 수정</div>
                        <v-spacer></v-spacer>
                        <v-icon
                            color="white"
                            small
                    ...
                    <v-card-text>
                        <div>
                            <Number label="ReadingActivityId" v-model="selectedRow.readingActivityId" :editMode="true"/>
                            <String label="UserId" v-model="selectedRow.userId" :editMode="true"/>
                            <String label="BookId" v-model="selectedRow.bookId" :editMode="true"/>
                            <Number label="CurrentPage" v-model="selectedRow.currentPage" :editMode="true"/>
                            <String label="ReadingStatus" v-model="selectedRow.readingStatus" :editMode="true"/>
